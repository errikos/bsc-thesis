...
?- subset(P, q).
   ...
   (1) $\sim$(\underline{non_subset(P, q)}) ?
...
Our modified definition adds the restriction upon the application of the constructive negation rule. That means that the restriction
