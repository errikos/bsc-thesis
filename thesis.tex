...
Imagine that there is a collection of books, each of which costs a certain amount of money. Imagine that you have decided that you want to buy three books for your summer holidays and you really want them to be detective novels. However, you can only spend a limited amount of money for books, say \msf{X}. Therefore, you would like to buy three detective novels that do not exceed amount \msf{X} in cost.

Notice the order of preferences above. The first is the genre. You absolutely enjoy reading detective novels while on the beach. The price comes second. This order of preferences may, depending on the collection of books, force you to buy less than three books (in case there are not enough books of the selected genre in the collection).
...
The term \emph{higher-order} refers to the capability of applying and passing around predicates and predicate variables as parameters. This is the most popular feature of higher-order logic programming languages like HiLog.
